...
type SlaveLoc struct {
	...
	SlaveLocation *Location `protobuf:"bytes,2,opt,name=slave_location,json=slaveLocation" json:"slave_location,omitempty"`
}

func (m *SlaveLoc) Reset()                    { *m = SlaveLoc{} }
func (m *SlaveLoc) String() string            { return proto.CompactTextString(m) }
func (*SlaveLoc) ProtoMessage()               {}
func (*SlaveLoc) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (m *SlaveLoc) GetSlaveLocation() *Location {
	if m != nil {
		return m.SlaveLocation
	}
	return nil
}
...
func (*MasterOrder) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func init() {
	...
	proto.RegisterType((*Location)(nil), "ticket.Location")
...
type TicketClient interface {
	...
	SlaveSubmit(ctx context.Context, opts ...grpc.CallOption) (Ticket_SlaveSubmitClient, error)
...
func (c *ticketClient) SlaveSubmit(ctx context.Context, opts ...grpc.CallOption) (Ticket_SlaveSubmitClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Ticket_serviceDesc.Streams[0], c.cc, "/ticket.Ticket/SlaveSubmit", opts...)
	if err != nil {
		return nil, err
	}
	x := &ticketSlaveSubmitClient{stream}
	return x, nil
}

type Ticket_SlaveSubmitClient interface {
	Send(*SlaveLoc) error
	Recv() (*MasterOrder, error)
	grpc.ClientStream
}

type ticketSlaveSubmitClient struct {
	grpc.ClientStream
}

func (x *ticketSlaveSubmitClient) Send(m *SlaveLoc) error {
	return x.ClientStream.SendMsg(m)
}

func (x *ticketSlaveSubmitClient) Recv() (*MasterOrder, error) {
	m := new(MasterOrder)
...
type TicketServer interface {
	...
	SlaveSubmit(Ticket_SlaveSubmitServer) error
...
func _Ticket_SlaveSubmit_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TicketServer).SlaveSubmit(&ticketSlaveSubmitServer{stream})
}

type Ticket_SlaveSubmitServer interface {
	Send(*MasterOrder) error
	Recv() (*SlaveLoc, error)
	grpc.ServerStream
}

type ticketSlaveSubmitServer struct {
	grpc.ServerStream
}

func (x *ticketSlaveSubmitServer) Send(m *MasterOrder) error {
	return x.ServerStream.SendMsg(m)
}

func (x *ticketSlaveSubmitServer) Recv() (*SlaveLoc, error) {
	m := new(SlaveLoc)
...
var fileDescriptor0 = []byte{
	...
	,
}
