...
type HareRangeRequest struct {
	Mid string `protobuf:"bytes,1,opt,name=mid" json:"mid,omitempty"`
}

func (m *HareRangeRequest) Reset()                    { *m = HareRangeRequest{} }
func (m *HareRangeRequest) String() string            { return proto.CompactTextString(m) }
func (*HareRangeRequest) ProtoMessage()               {}
func (*HareRangeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *HareRangeRequest) GetMid() string {
	if m != nil {
		return m.Mid
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*HareRangeRequest)(nil), "ticket.HareRangeRequest")
...
type TicketClient interface {
	...
	PullHareRange(ctx context.Context, in *HareRangeRequest, opts ...grpc.CallOption) (Ticket_PullHareRangeClient, error)
...
func (c *ticketClient) PullHareRange(ctx context.Context, in *HareRangeRequest, opts ...grpc.CallOption) (Ticket_PullHareRangeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Ticket_serviceDesc.Streams[0], c.cc, "/ticket.Ticket/PullHareRange", opts...)
	if err != nil {
		return nil, err
	}
	x := &ticketPullHareRangeClient{stream}
...
type Ticket_PullHareRangeClient interface {
	Recv() (*HareProfiles, error)
	grpc.ClientStream
}

type ticketPullHareRangeClient struct {
	grpc.ClientStream
}

func (x *ticketPullHareRangeClient) Recv() (*HareProfiles, error) {
	m := new(HareProfiles)
...
func (c *ticketClient) MasterReceive(ctx context.Context, opts ...grpc.CallOption) (Ticket_MasterReceiveClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Ticket_serviceDesc.Streams[1], c.cc, "/ticket.Ticket/MasterReceive", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *ticketClient) PullLocation(ctx context.Context, in *PullLocRequest, opts ...grpc.CallOption) (Ticket_PullLocationClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Ticket_serviceDesc.Streams[2], c.cc, "/ticket.Ticket/PullLocation", opts...)
	if err != nil {
		return nil, err
	}
...
type TicketServer interface {
	...
	PullHareRange(*HareRangeRequest, Ticket_PullHareRangeServer) error
...
func _Ticket_PullHareRange_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(HareRangeRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TicketServer).PullHareRange(m, &ticketPullHareRangeServer{stream})
}

type Ticket_PullHareRangeServer interface {
	Send(*HareProfiles) error
	grpc.ServerStream
}

type ticketPullHareRangeServer struct {
	grpc.ServerStream
}

func (x *ticketPullHareRangeServer) Send(m *HareProfiles) error {
...
var _Ticket_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "PullHareRange",
			Handler:       _Ticket_PullHareRange_Handler,
			ServerStreams: true,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
