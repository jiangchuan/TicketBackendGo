...
type TicketDetails struct {
	...
	Longitude    float64 `protobuf:"fixed64,13,opt,name=longitude" json:"longitude,omitempty"`
	Latitude     float64 `protobuf:"fixed64,14,opt,name=latitude" json:"latitude,omitempty"`
	MapImage     []byte  `protobuf:"bytes,15,opt,name=map_image,json=mapImage,proto3" json:"map_image,omitempty"`
	FarImage     []byte  `protobuf:"bytes,16,opt,name=far_image,json=farImage,proto3" json:"far_image,omitempty"`
	CloseImage   []byte  `protobuf:"bytes,17,opt,name=close_image,json=closeImage,proto3" json:"close_image,omitempty"`
	TicketImage  []byte  `protobuf:"bytes,18,opt,name=ticket_image,json=ticketImage,proto3" json:"ticket_image,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
